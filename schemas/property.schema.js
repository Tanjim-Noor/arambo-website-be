/**
 * Property MongoDB Schema Definition
 * Complete schema for the Property collection with validation, indexes, and middleware
 */
...
const PropertySchema = new Schema({
  ...
  // FACILITY BOOLEAN FIELDS (all default to false)
  cctv: {
    type: Boolean,
    default: false
  },
...
PropertySchema.statics.findByListingType = function(listingType) {
...
PropertySchema.statics.findByLocationPattern = function(locationPattern) {
  return this.find({ 
